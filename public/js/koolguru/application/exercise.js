    ...
    excercise = {
        ...
        rendercurrentquestion : function(){
            ...
            for(key in options){                
                ...
                renderhtml += "<span style='position: absolute; left: 200px;'>"+obj.description+"<span></label>";
                renderhtml += "<span id='"+key+"-message' style='margin-left: 164px' class='optionmsg'></span></li>";
            }            
            renderhtml += "</ul>";
            renderhtml += "</div>";
        ...
        submitquestion : function(){
            ...
            console.log($('input[name="option"]:checked').length);
